	...
	internal sealed class JwtProvider : IJwtProvider
	{
		public string CreateToken(AppUser user)
		{
			...
			JwtSecurityToken securityToken = new(
				issuer: "", //uygulamanın kimin tarafından oluşturulduğu
				audience: "", //uygulamayı kimin kullanacağı
				claims: claims, //
				notBefore: DateTime.Now, //oluşturduğum andan itibaren kullanılabilir.
				expires: expires,

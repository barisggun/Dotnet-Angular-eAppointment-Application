...
namespace eAppointmentServer.Domain.Enums
{
	...
	{
		public static readonly DepartmentEnum Acil = new("Acil", 1); //Geriye department enum dönen anlamına geliyor.
		public static readonly DepartmentEnum Radyolji = new("Radyoloji", 2);
